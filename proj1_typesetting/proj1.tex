\documentclass[10pt,a4paper,twocolumn, hidelinks]{article}
...
\begin{quotation}
    Čím více \textsc{druhů}, \emph{řezů}, {\scriptsize velikostí}, \textcolor{red}{barev} písma a jiných \verb|efektů| použijeme, \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} vypadat.
